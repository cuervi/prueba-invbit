				...
				<div class="grid grid-cols-1 md:grid-cols-2">
					<div class="p-6">
						...
						<div class="ml-12">
							<div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
								...
								of the documentation from beginning to end.</div>
						</div>
					</div>
					...
					<div
						...
						<div class="ml-12">
							<div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
								...
								and massively level up your development skills in the process.</div>
						</div>
					</div>
					...
					<div
						...
						<div class="flex items-center">
							...
							<div
								class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Vibrant
								Ecosystem</div>
						</div>
						...
						<div class="ml-12">
							<div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
								...
								powerful open source libraries like <a
									href="https://laravel.com/docs/billing" class="underline">Cashier</a>,
								...
								<a href="https://laravel.com/docs/broadcasting"
									...
									href="https://laravel.com/docs/horizon" class="underline">Horizon</a>,
				...
				<div class="text-center text-sm text-gray-500 sm:text-left">
					<div class="flex items-center">
						...
						<a href="https://github.com/sponsors/taylorotwell"
							class="ml-1 underline"> Sponsor </a>
					</div>
				</div>
