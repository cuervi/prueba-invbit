	...
	<div class="row">
		<div class="col-12 mb-3">
			<button id="exportExcel" data-toggle="modal"
				data-target="#form-Modal" class="btn btn-primary mr-1">Crear Usuario
			</button>
		</div>
	</div>
	<!-- basic table -->
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal"
					title="@lang('website.close')" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				<form id="registerRoutesForm"
					action="{{ route('testuser.create') }}" method="POST">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label>Nombre</label> <input type="text" class="form-control"
									id="name" name="name" placeholder="Nombre" autocomplete="off">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Nota Media</label> <input type="number"
									class="form-control" id="average" name="average"
									placeholder="Nota media" autocomplete="off">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>Fecha de nacimiento</label> <input type="date"
									name="bithdate" id="birthdate" class="form-control"
					...
					<div>
						<button type="submit" id="submit"
							class="btn btn-rounded btn-primary float-right modal-confirm">@lang('website.add-transportr-btn')</button>
					</div>
				</form>
			</div>
		</div>
